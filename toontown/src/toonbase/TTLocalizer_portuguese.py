...
lMinniesMelodilândia = "Melodilândia da Minnie"
...
MinniesMelodilândia = ("para a",  "na",    lMinniesMelodilândia)
...
FactoryNames = {
    ...
    13300 : 'Escritório dos Cog Robô da Lei', #remove me JML
    }
...
# _where_ gets replaced with a description of where to find the npc, with a leading \x07
...
QuestsItemDict = {
    ...
    # Minnie's Melodilândia quest items
...
QuestDialogDict = {
    160 : {GREETING : "",
          QUEST : "Ok, agora acho que você está pronto para um recompensador maior.\x07Se você poder derrotar 3 Robôs-chefe eu te darei um pequeno bônus.",
    ...
    161 : {GREETING : "",
           QUEST : "Ok, agora acho que você está pronto para um recompensador maior.\x07Volte depois de derrotar 3 Robôs da Lei e terei uma coisinha nova.",
    ...
    162 : {GREETING : "",
           QUEST : "Ok, agora acho que você está pronto para um recompensador maior.\x07Derrote 3 Robôs Mercenários e volte aqui para resgatar a recompensa.",
           INCOMPLETE_PROGRESS : TheCogs +" estão soltos pelas ruas e pelos túneis.",
    ...
    163 : {GREETING : "",
           QUEST : "Ok, agora acho que você está pronto para um recompesador maior.\x07Venha nos ver depois de derrotar 3 Robôs Vendedores e nós o conectaremos.",
           INCOMPLETE_PROGRESS : TheCogs +" estão soltos pelas ruas e pelos túneis.",
    ...
    165 : {QUEST : "Olá.\x07Parece que você precisa praticar suas piadas.\x07Toda vez que você atinge um Cog com uma de suas piadas, sua experiência aumenta.\x07Quando tiver experiência suficiente, você será capaz de usar uma piada ainda melhor.\x07Vá praticar suas piadas derrotando 4 Cogs."},
    ...
    1055 : { QUEST : "Oláááá! Eu não consigo encontrar os pneus para este carro de palhaço em lugar nenhum!\x07Você acha que pode me ajudar?\x07Eu acho que o Tito Tonto pode ter jogado os pneus no lago do pátio do "+lToontownCentral+".\x07Se você ficar em um dos cais de lá, poderá tentar pescar os pneus para mim.",
             GREETING : "Iuhuu!",
             LEAVING : "",
    ...
    1063 : { QUEST : "Olá! Legal você ter vindo.\x07Um Cog roubou um pacote muito importante bem debaixo do meu nariz.\x07Veja se você consegue recuperá-lo. Eu acho que ele era de nível 3...\x07Então, derrote Cogs de nível 3 até encontrar meu pacote.",
             LEAVING : "",
    ...
    2903 : { QUEST : "Olá!\x07Sim, eu ouvi falar no caranguejo gigante que Salgado está construindo.\x07A melhor braçadeira que tenho está meio suja.\x07Seja gentil e passe pela lavanderia antes de levá-la para ele._where_",
             LEAVING : "Valeu!"
             },
    ...
    3205 : { QUEST : "Olá, _avName_! Você veio me ajudar?\x07Acabei de expulsar um Sanguessuga de minha loja. Puxa! Foi horrível.\x07Mas agora não encontro minha tesoura em lugar nenhum! Tenho certeza de que o Sanguessuga a levou.\x07Encontre-o e recupere minha tesoura.",
             LEAVING : "",
    ...
    3262 : { QUEST : "_toNpcName_ tem novas informações sobre a Fábrica do "+lSellbotHQ+".\x07Vá ver o que ele tem a dizer._where_" },
    ...
    4909 : { QUEST : "Desculpe.\x07Minha memória está ficando meio confusa.\x07Se você recuperar um edifício de três andares, tenho certeza de que estarei pronta quando voltar...",
             },
    4910 : { QUEST : "Tudo pronto!\x07Desculpe a demora.\x07Leve isto para o Léo._where_",
             GREETING : "",
    ...
    5216 : { QUEST : "Falamos que ajudaríamos você.\x07Então, pegue este anel e leve à garota.",
             GREETING : "",
             LEAVING : "",
...
WinterMinnieCChatter = (
        [ # Greetings
        "Oi, eu sou a Minnie Feliz!",
        "Bem-vindo à terra das canções de natal!",
        "Feliz Feriado de Inverno!",
        "Feliz Feriado de Inverno, %!",
        ],
        [ # Comments
        "Você receberá mais do que um Barbearia Musical se você cantar para a Bárbara de Sevilha!",
        "Cante uma melodia, Toon!",
        "Você receberá mais do que um Barbearia Musical se você cantar para a Bárbara de Sevilha!",
        "Mostre-nos como cantarolar, Toon!",
        "Você receberá mais do que um Barbearia Musical se você cantar para a Bárbara de Sevilha!",
        "Você consegue trazer uma melodia aqui em Melodilândia?",
        "Você receberá mais do que um Barbearia Musical se você cantar para a Bárbara de Sevilha!",
...
ValentinesMinnieChatter = (
    [
    "Olá, Eu sou a Minnie!",
    "Feliz dia do Toon dos Namorados!",
    "Feliz dia do Toon dos Namorados, %",
    ],
    [
    "Eu espero o Mickey me dar chocolate ou flores!",
    "Esses corações são bom para acrescentar sua Risada!",
    "Eu quero ir para uma Festa de Toon dos Namorados!",
...
WitchMinnieChatter = (
        [ # Greetings
        "Bem vindo á Magicalândia... quero dizer Melodilândia!",
        "Oi, meu nome é Minnie Magica! Qual é o seu?",
...
AFMickeyChatter = (
        ...
        [ # Comments
        "Bem vindo aos Jardins! Eu sou " + Daisy + "!",
	"Eu sou a " + Daisy + ", e Eu amo o jardim!",
        "A Semana dos Toons de Abril é a semana mais boba do ano!",
	"Que, você nunca viu uma pata com orelhas de ratos?",
        "Oi, Eu sou a " + Daisy + "! Quack!",
	"Fica dificil imitar som de pato!",
        "Não estou me sentindo eu mesmo hoje!",
        "Você ouviu um Rabisco falar?",
	"Ah Gravidade está de férias nas Propriedades!",
        ],
        [ # Goodbyes
        "Tenha uma Semana de Toons de Abril Maluca!",
        "Fala com o Mickey que eu diz oi!",
        ]
    )
...
AFMinnieChatter = (
        ...
        [ # Comments
        "Bem vindo ao " + lTheBrrrgh + "! Eu sou o " + Pluto + "!",
	"Oi, meu nome é " + Pluto + ". Qual é o seu?",
        "Que você nunca viu um cachorro com orelhas de rata?",
        "Você tem um biscoito canino? Eu estou com Fome!",
	"Au Au! Meu nome é " + Pluto + "!",
        "Isto é engraçado?",
	"Não faça eu segui ao redor!", 
	"Semana dos Toons de Abril é um semana boba do ano!",
 	"Você ouviu um Rabisco falar?",
  	"Ah Gravidade está de férias nas Propriedades!",
        ],
        [ # Goodbyes
        "Tenha uma Semana de Toons de Abril Maluca!",
        "Eu tenho que seguir aquele carro agora! Tchau!",
        ]
    )
...
AFDaisyChatter = (
        ...
        [ # Comments
	"Bem vindo ao "+lToontownCentral+"! Eu sou o "+Mickey+" Mouse!",
        "Oi, Eu sou "+Mickey+"! O rato muito alegre em Toontown",
	"Se você achar a "+Daisy+", diga a ela que o "+Mickey+" diz oi!",
        "Que, você nunca viu um rato com penas?",
	"Isto é engraçado?"
        "Não estou me sentindo eu mesma hoje!",
	"Semana dos Toons de Abril é um semana boba do ano!",
	"Você ouviu um Rabisco falar ou estou ouvindo coisas?",
 	"Ah Gravidade está de férias nas Propriedades!",
        ],
        [ # Goodbyes
	"Tchau! Fala com o "+Mickey+" te enviei!",
 	"Se você for no "+lDaisyGardens+", diga oi para ele por mim!", 
        ]
    )
...
AFGoofySpeedwayChatter = (
        ...
        [ # Comments
        "Bem vindo a Sonholândia! Eu sou o "+Donald+"!",
        "Olá, Eu sou o "+Donald+"! Já é hora da soneca?",
	"Um pato precisa está como uma fera, eu sei!",
 	"Que você nunca viu um pato com orelhas de cachorro?",
        "Yahoo! Quero dizer -- Quack!",
	"Isso seria uma ótima pista de corrida... hum, quero dizer, um lugar para tirar uma soneca!",
        "Não estou me sentindo eu mesmo hoje!",
	"Semana dos Toons de Abril é um semana boba do ano!",
...
PartyActivityNameDict = {
    ...
    15: {
        ...
        "description" : "Pega seu Toon de Namoro Vamos lá!"
    },
    16: {
        "generic" : "Pista de Dança\n20 passos",
...
PartyDecorationNameDict = {
    ...
    22 : {
        "editor" : "CogCiclo",
        "description" : "Um Cog em sua melhor forma nas férias."
    },
    23 : {
        "editor" : "Coreto de Feriado",
        "description" : "Todos adoram uma Festa de Feriado!"
    },
    24 : {
        "editor" : "Cog Pimentado",
    ...
    27: {
        "editor": "Birgona de Toon de Namorados",
